...
public class AddAppointmentViewController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        this.idTf.setText(String.valueOf(AppointmentDBA.getAllAppointments().size() + 1));
    ...
    private void saveBtnAction(ActionEvent event) {
        ...
        if (errCounter == 10) {
            ...
            boolean isAdded = AppointmentDBA.addAppointment(appointment);
            if (isAdded) {
                Alert alert = new Alert(Alert.AlertType.INFORMATION);
                alert.setTitle("Appointment Insertion");
                alert.setContentText("Appointment " + title + " is Added Successfully");
